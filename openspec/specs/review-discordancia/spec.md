# review-discordancia Specification

## Purpose
Sinalização estruturada e auditável de discordância de classificação pelo Review Agent, com `motivo`, `ambiguidade_sugerida`, propagação no payload do HITL e registro na Audit com `origem_discordancia`.
